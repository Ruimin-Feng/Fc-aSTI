...
mask_data=load(fullfile(GTpath,'WMMask.mat'));
mask=mask_data.WMMask;
...
Fc_symm_Fs_data=load_nii(fullfile(folder,'f_non_Fc-STI.nii'));
Fc_symm_Fs=Fc_symm_Fs_data.img;
Fc_asymm_Fs_data=load_nii(fullfile(folder,'f_non_Fc-aSTI.nii'));
Fc_asymm_Fs=Fc_asymm_Fs_data.img;

disp('=================');
fprintf('RMSE of offset reconstructed by Fc-STI: %4.2f\n',compute_rmse(Fc_symm_Fs,Fc_GT));
fprintf('RMSE of offset reconstructed by Fc-aSTI: %4.2f\n',compute_rmse(Fc_asymm_Fs,Fc_GT));

fprintf('SSIM of MSA reconstructed by Fc-STI: %4.2f\n',compute_ssim(Fc_symm_Fs,Fc_GT));
fprintf('SSIM of MSA reconstructed by Fc-aSTI: %4.2f\n',compute_ssim(Fc_asymm_Fs,Fc_GT));
